...
BlockIO executeDDLQueryOnCluster(const ASTPtr & /*query_ptr*/, ContextPtr /*context*/) { return {}; }
BlockIO executeDDLQueryOnCluster(const ASTPtr & /*query_ptr*/, ContextPtr /*context*/, const AccessRightsElements & /*query_requires_access*/) { return {}; }
BlockIO executeDDLQueryOnCluster(const ASTPtr & /*query_ptr*/, ContextPtr /*context*/, AccessRightsElements && /*query_requires_access*/) { return {}; }
